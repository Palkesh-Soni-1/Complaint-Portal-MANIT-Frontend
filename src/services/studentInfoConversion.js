export default function infoConverter(studentData) {
  ...
  newStudentData.fullName =
    studentData?.basicInfo?.userInfo?.cn;
  ...
  newStudentData.semester = `Semester ${studentData?.resultData?.data?.FINAL_CGPA?.length+1}`;
  ...
  newStudentData.maritalStatus = studentData?.advancedInfo?.marital_status || "N/A";
  ...
  newStudentData.motherTongue = studentData?.advancedInfo?.mother_tongue || "N/A";
  ...
  newStudentData.passportNumber = studentData?.advancedInfo?.passport_no || "N/A";
  ...
  newStudentData.fatherName =
    studentData?.advancedInfo?.father_name || "N/A";
  ...
  newStudentData.parentsAddress = studentData?.advancedInfo?.guardian_address || "N/A";
  ...
  newStudentData.guardianName = studentData?.advancedInfo?.guardian_name || "N/A";
  newStudentData.relationshipWithGuardian = "N/A";
  newStudentData.guardianAddress = studentData?.advancedInfo?.guardian_address || "N/A";
  newStudentData.guardianPhone =
    studentData?.advancedInfo?.guardian_phone_no || "N/A";
  newStudentData.guardianEmail =
    studentData?.advancedInfo?.guardian_email || "N/A";
  newStudentData.phoneNumber =
    studentData?.advancedInfo?.phone_number || "N/A";
